...
3. B 模式覆盖: B/C/D/K 列永远跟 DB 一致, E 列匹配键
...
class DailyReportWriter:
    ...
    def flush_today(self):
        """每日定时调度入口. 步骤 2.7 实现."""
        raise NotImplementedError("step 2.7")
